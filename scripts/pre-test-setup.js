...
const dbName = process.env.DB_NAME || envConfig.DB_NAME;
const dbUser = process.env.DB_USER || envConfig.DB_USER;
const dbPassword = process.env.DB_PASSWORD || envConfig.DB_PASSWORD;
const testUsername = process.env.TEST_USERNAME || envConfig.USERNAME;
